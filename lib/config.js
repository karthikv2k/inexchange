...
CONFIG.common=function(){
  ...
  ACTIONS={
    "answer,accepted":"accepted an answer"
   ,"answer,answered":"posted an answer"
   ,"question,asked":"asked a question"
   ,"question,badge":"earned a badge"
   ,"question,commented":"posted a comment"
   ,"question,reviewed":"reviewed a suggested edit"
   ,"question,revision":"edited a post"
   ,"question,suggested":"suggested an edit"
  }
  LI_SHARE_PROXY="http://localhost:4567/li_post"  
}
